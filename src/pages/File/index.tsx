...
import { Button, Card, Divider, Drawer, Image, message, Popconfirm, Space, Spin } from 'antd';
...
export default () => {
  ...
  return (
    <div>
      ...
      {/* 文件上传弹窗 */}
      <FileUpload dir={dirName} open={openUploadModalOpen} onSuccess={() => getFileList(dirName)} onCancel={() => setOpenUploadModalOpen(false)} />

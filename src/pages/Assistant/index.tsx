    ...
    <div>
          ...
          renderItem={(item) => (
            <List.Item
              actions={[
                ...
                <Popconfirm key="delete" title="您确定要删除这个助手吗？" onConfirm={() => delAssistantData(+item.id)} okText="确定" cancelText="取消">
      ...
      >
        <Form form={form} layout="vertical" size="large">
          ...
          <Form.Item name="key" label="API密钥" rules={[{ required: true, message: '请输入API密钥' }]}>
